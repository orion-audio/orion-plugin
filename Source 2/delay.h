...
public:
    ...
    float bysamples(float input)
    {
        ...
        //std::cout<<"before filter "<<out<<"\n";
        //wetMix_ = lowpass.processSingleSampleRaw(WetMix_);
        //std::cout<<"after filter "<<out<<"\n";
        //out = highpass.processSingleSampleRaw(out);
        ...
        //std::cout<<"delay buffer: "<<delayBufferLength_<<"\n";
        //std::cout<<"read: "<<dpr<<" write: "<<dpw<<"\n";
        //delayReadPosition_ = dpr;
        //delayWritePosition_ = dpw;
        return out;
    };
